...
goog.require('lt.objs.editor.pool');
goog.require('lt.objs.command');
lt.plugins.howdoi.append_text = (function append_text(text){var cm = lt.objs.editor.__GT_cm_ed.call(null,lt.objs.editor.pool.last_active.call(null));var current_line = cm.getCursor().line;return cm.replaceRange(text,cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"line","line",1017226086),(current_line + 1),new cljs.core.Keyword(null,"ch","ch",1013907415),0], null)),cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"line","line",1017226086),(current_line + 1),new cljs.core.Keyword(null,"ch","ch",1013907415),0], null)));
});
lt.plugins.howdoi.__BEH__ask_howdoi = (function __BEH__ask_howdoi(this$){var cm = lt.objs.editor.__GT_cm_ed.call(null,lt.objs.editor.pool.last_active.call(null));var current_line = cm.getCursor().line;var current_line_text = cm.getLine(current_line);return lt.objs.proc.exec.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"command","command",1964298941),"howdoi",new cljs.core.Keyword(null,"args","args",1016906831),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [current_line_text], null),new cljs.core.Keyword(null,"obj","obj",1014014057),lt.plugins.howdoi.howdoi], null));
});
